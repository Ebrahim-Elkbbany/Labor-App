...
class SwitchNotificationContainer extends StatefulWidget {
  ...
  @override
  State<SwitchNotificationContainer> createState() =>
      _SwitchNotificationContainerState();
}

class _SwitchNotificationContainerState
    extends State<SwitchNotificationContainer> {
  bool notify = false;
